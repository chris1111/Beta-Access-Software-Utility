...
# Beta Access Software Utility.app Copyright (c) 2020 chris1111 All rights reserved.
display dialog "
Welcome Beta Access Software Utility

Here are the choices that will be offered to you
(Default Update), (Public Access), (Developer Access)

Quit to go out and make no choice.  
" with icon note buttons {"Quit", "Continue"} default button {"Continue"} cancel button {"Quit"}
set theAction to button returned of (display dialog "
Welcome Developer Beta Access Software
